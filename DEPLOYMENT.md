...
Infrastructure generated by [Sirpi](https://sirpi.dev) for your **n8n** application.
...
2. Verify your app responds on port 5678
3. Test health check endpoint locally: `curl http://localhost:5678/`
...
- Security groups restrict traffic (ALB → ECS on port 5678 only)
...
<sub>Generated by Sirpi • Session: sess_69aeea19e223 • [View Original Generation](https://sirpi.dev/generation/sess_69aeea19e223)</sub>
